...
class GrpcService(
    ...
    private val responseObserver = object : StreamObserver<MessageGroupBatch> {
        ...
        override fun onError(t: Throwable?) = LOGGER.error(t) { "gRPC request failed." } // TODO
        override fun onCompleted() {} // TODO
    }

    override fun decode(batch: MessageGroupBatch) = codecService.decode(batch, responseObserver)
    override fun decode(batch: MessageGroupBatch, sessionAlias: String) = codecService.decode(batch, mapOf(SESSION_ALIAS_LABEL to sessionAlias), responseObserver)
