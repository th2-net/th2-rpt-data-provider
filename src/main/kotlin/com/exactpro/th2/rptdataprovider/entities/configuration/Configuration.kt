...
class CustomConfigurationClass {
    ...
    override fun toString(): String {
        return "CustomConfigurationClass(codecCacheSize=$codecCacheSize, hostname='$hostname', port=$port, responseTimeout=$responseTimeout, serverCacheTimeout=$serverCacheTimeout, eventCacheSize=$eventCacheSize, messageCacheSize=$messageCacheSize, ioDispatcherThreadPoolSize=$ioDispatcherThreadPoolSize, checkRequestsAliveDelay=$checkRequestsAliveDelay, enableCaching=$enableCaching, notModifiedObjectsLifetime=$notModifiedObjectsLifetime, rarelyModifiedObjects=$rarelyModifiedObjects, sseEventSearchStep=$sseEventSearchStep, keepAliveTimeout=$keepAliveTimeout, messageExtractorOutputBatchBuffer=$messageExtractorOutputBatchBuffer, messageConverterOutputBatchBuffer=$messageConverterOutputBatchBuffer, messageDecoderOutputBatchBuffer=$messageDecoderOutputBatchBuffer, messageUnpackerOutputMessageBuffer=$messageUnpackerOutputMessageBuffer, messageFilterOutputMessageBuffer=$messageFilterOutputMessageBuffer, messageMergerOutputMessageBuffer=$messageMergerOutputMessageBuffer, codecResponseTimeout=$codecResponseTimeout, codecPendingBatchLimit=$codecPendingBatchLimit, codecCallbackThreadPool=$codecCallbackThreadPool, codecRequestThreadPool=$codecRequestThreadPool, codecUsePinAttributes=$codecUsePinAttributes, grpcWriterMessageBuffer=$grpcWriterMessageBuffer, grpcThreadPoolSize=$grpcThreadPoolSize, cradleDispatcherPoolSize=$cradleDispatcherPoolSize, sseSearchDelay=$sseSearchDelay, rabbitBatchMergeBuffer=$rabbitBatchMergeBuffer, sendEmptyDelay=$sendEmptyDelay, eventSearchChunkSize=$eventSearchChunkSize, sendPipelineStatus=$sendPipelineStatus, pipelineInfoSendDelay=$pipelineInfoSendDelay, useStrictMode=$useStrictMode, serverType=$serverType)"
    }
