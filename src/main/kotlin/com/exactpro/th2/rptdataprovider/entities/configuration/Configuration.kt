...
class Configuration(args: Array<String>) {
    ...
    val getEventsLimit: Variable =
        Variable("getEventsLimit", customConfiguration.getEventsLimit.toString(), "100")
}